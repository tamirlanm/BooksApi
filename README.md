...
**Books API** — это RESTful веб-сервис для управления библиотекой книг, написанный на **ASP.NET Core (.NET 10)**. Проект демонстрирует использование современных архитектурных подходов, таких как Clean Architecture (N-Tier), Repository & Unit of Work паттерны, а также контейнеризацию с помощью Docker.
